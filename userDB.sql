...
CREATE PROCEDURE proc_insert_user(IN parm_firstname VARCHAR(255),
...
BEGIN
	...
	INSERT INTO tbl_users(fld_u_firstname,
	                      fld_u_lastname,
	                      fld_u_email,
	                      fld_u_pswd)
					VALUES(parm_firstname, parm_lastname, parm_email, parm_pswd);
END $$
